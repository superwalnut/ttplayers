...
@Component({
  selector: 'app-player-match-score-stats-item-seven-sets',
  templateUrl: './player-match-score-stats-item-seven-sets.component.html',
  styleUrls: ['./player-match-score-stats-item-seven-sets.component.scss']
})
export class PlayerMatchScoreStatsItemSevenSetsComponent  implements OnInit{
  @Input() player:Player;
  @Input() matchStatsSets:MatchScoreStats[];
  chartName:string = "Sets7Chart";
  chart:any;
  totalMatches:number;
