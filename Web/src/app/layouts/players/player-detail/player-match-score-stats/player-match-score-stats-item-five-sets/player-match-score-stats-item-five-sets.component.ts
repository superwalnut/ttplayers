...
@Component({
  selector: 'app-player-match-score-stats-item-five-sets',
  templateUrl: './player-match-score-stats-item-five-sets.component.html',
  styleUrls: ['./player-match-score-stats-item-five-sets.component.scss']
})
export class PlayerMatchScoreStatsItemFiveSetsComponent  implements OnInit{
  @Input() player:Player;
  @Input() matchStatsSets:MatchScoreStats[];
  chartName:string = "Sets5Chart";
  chart:any;
  totalMatches:number;
